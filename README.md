[![paypal](https://img.shields.io/badge/-Donate-yellow.svg?longCache=true&style=for-the-badge)](https://www.paypal.me/muttakinhasibInitiative)
...
[![MIT License][mit-badge]][mit-link] [![][ver-badge]][ver-link] [![Join the chat at https://gitter.im/muttakinhasib/zinit][gitter-badge]][gitter-link] [![Subscribe to r/zinit sub][reddit-badge]][reddit-link]
...
<p align="center">
<a href="https://github.com/muttakinhasib/zinit">
<img src="https://raw.githubusercontent.com/muttakinhasib/zinit/images/zinit.png"/>
</a>
</p>
...
- 20-06-2020
  ...
  - I thought that I'll share an interesting function-type that I'm using within
    ...
    ![screenshot](https://raw.githubusercontent.com/muttakinhasib/zinit/master/doc/img/m.png)
...
- 09-05-2020
  ...
  - A new ice `opts''` which takes options to **sticky-set** during sourcing of
    ...
    zinit opts"kshglob noshglob" for muttakinhasib/test
    ...
    zinit sh opts"kshglob" for muttakinhasib/test
...
- 12-04-2020
  ...
  - A new document on the Wiki is available — about the [**bindmap''
    ice**](https://muttakinhasib.github.io/zinit/wiki/Bindkeys/).
  - If `id-as''` will have no value, then it'll work as
    [**id-as'auto'**](https://muttakinhasib.github.io/zinit/wiki/id-as/#id-asauto).
...
- 07-04-2020
  ...
  - A new feature — `param''` ice that defines params for the time of loading of
    ...
    zinit param'myparam → 1; myparam2 -> 1' for muttakinhasib/null
    # Equivalent of `local myparam myparam2' before loading of the plugin
    zinit param'myparam; myparam2' for muttakinhasib/null
    ```
...
- 01-04-2020
  ...
  - As a user [noticed](https://github.com/muttakinhasib/zinit/issues/293), Subversion
...
- 20-02-2020
  ...
  - A new article is available on the Wiki — about the
    [**`extract`**](http://muttakinhasib.github.io/zinit/wiki/extract-Ice/) ice.
...
- 19-01-2020
  ...
  - The name has been changed to **Zinit** based on the results of the
    [poll](https://github.com/muttakinhasib/zinit/issues/235).
...
- 15-01-2020
  ...
  - There's a new function, `ziextract`, which unpacks the given file. It supports many
    ...
    request](https://github.com/muttakinhasib/zinit/issues/new?template=feature_request.md)
...
- 11-12-2019
  ...
  - Zinit now supports installing special-Zsh NPM packages! Bye-bye the long and
    ...
    [Wiki](https://muttakinhasib.github.io/zinit/wiki/Zinit-Packages/) for an introductory document
    on the feature.
...
- 07-11-2019
  ...
  - Added a prefix-char: `@` that can be used before plugins if their name collides
    ...
    See the [Zinit Wiki](http://muttakinhasib.github.io/zinit/wiki/For-Syntax/) for more
  ...
  - A new syntax, called for-syntax. Example:
    ...
    ```zsh
     zinit as"program" atload'print Hi!' for \
         atinit'print First!' muttakinhasib/null \
    ...
    /root/.zinit/plugins/muttakinhasib---null
    ```

    To load in light mode, use a new `light-mode` ice. More examples and information
    can be found on the [Zinit Wiki](https://muttakinhasib.github.io/zinit/wiki/For-Syntax/).
...
- 30-10-2019
  ...
  - A new ice `trigger-load''` — create a function that loads given plugin/snippet,
    ...
    zinit load muttakinhasib/zinit-crasis
    ```
...
- 10-09-2019
  ...
  - Three new Zinit annexes (i.e.
    [extensions](https://muttakinhasib.github.io/zinit/wiki/Annexes/)):
    ...
    - [z-a-man](https://github.com/zinit/z-a-man)
      ...
      [Zshelldoc](https://github.com/muttakinhasib/zshelldoc)).
...
<p align="center">
<a href="https://github.com/muttakinhasib/pm-perf-test">
<img width="550px" src="https://raw.githubusercontent.com/muttakinhasib/zinit/images/startup-times.png"/>
</a>
</p>
...
1. Zinit is currently the only plugin manager out there that provides Turbo mode
   ...
   **5** times faster!). Check out a speed comparison with other popular plugin
   managers [here](https://github.com/muttakinhasib/pm-perf-test).
...
4. The plugin manager supports loading Oh My Zsh and Prezto plugins and
   ...
   the Wiki, in the
   [Introduction](https://muttakinhasib.github.io/zinit/wiki/INTRODUCTION/#oh_my_zsh_prezto)).
...
6. Zinit supports special, dedicated **packages** that offload the user from
   ...
   page](https://muttakinhasib.github.io/zinit/wiki/Zinit-Packages/) for an article about
   the feature.
...
7. Also, specialized Zinit extensions — called **annexes** — allow to extend the
   ...
   article](https://muttakinhasib.github.io/zinit/wiki/Annexes/) for an introduction on
   creating your own annex.

# Zinit Wiki

The information in this README is complemented by the [Zinit
Wiki](https://muttakinhasib.github.io/zinit/wiki/). The README is an introductory overview of
...
```zsh
sh -c "$(curl -fsSL https://raw.githubusercontent.com/muttakinhasib/zinit/master/doc/install.sh)"
```
...
```sh
mkdir ~/.zinit
git clone https://github.com/muttakinhasib/zinit.git ~/.zinit/bin
```
...
[Click here to read the introduction to Zinit](https://muttakinhasib.github.io/zinit/wiki/INTRODUCTION/). It explains basic usage and some of the more unique features of Zinit such as the Turbo mode. If you're new to Zinit we highly recommend you read it at least once.
...
zinit load muttakinhasib/history-search-multi-word

# Two regular plugins loaded without investigating.
zinit light zsh-users/zsh-autosuggestions
zinit light muttakinhasib/fast-syntax-highlighting
...
[You can see an extended explanation of Oh-My-Zsh setup in the Wiki](http://muttakinhasib.github.io/zinit/wiki/Example-Oh-My-Zsh-setup/)
...
# https://muttakinhasib.github.io/zinit/wiki/For-Syntax/
zinit for \
    light-mode  zsh-users/zsh-autosuggestions \
    light-mode  muttakinhasib/fast-syntax-highlighting \
                muttakinhasib/history-search-multi-word \
...
# package under the path $ZPFX, see: http://muttakinhasib.github.io/zinit/wiki/Compiling-programs
...
[You can see an extended explanation of LS_COLORS in the Wiki.](https://muttakinhasib.github.io/zinit/wiki/LS_COLORS-explanation/)
...
[You can see an extended explanation of direnv in the Wiki.](https://muttakinhasib.github.io/zinit/wiki/Direnv-explanation/)

If you're interested in more examples then check out the [zinit-configs
repository](https://github.com/muttakinhasib/zinit-configs) where users have uploaded their
`~/.zshrc` and Zinit configurations. Feel free to
[submit](https://github.com/muttakinhasib/zinit-configs/issues/new?template=request-to-add-zshrc-to-the-zinit-configs-repo.md)
your `~/.zshrc` there if it contains Zinit commands.

You can also check out the [Gallery of Zinit
Invocations](https://muttakinhasib.github.io/zinit/wiki/GALLERY/) for some additional
examples.

Also, two articles on the Wiki present an example setup
[here](https://muttakinhasib.github.io/zinit/wiki/Example-Minimal-Setup/) and
[here](https://muttakinhasib.github.io/zinit/wiki/Example-Oh-My-Zsh-setup/).
...
[passed](http://muttakinhasib.github.io/zinit/wiki/Alternate-Ice-Syntax/) to `zinit ice ...` to
...
| [**`from`**](http://muttakinhasib.github.io/zinit/wiki/Private-Repositories/) | <div align="justify" style="text-align: justify;">Clone plugin from given site. Supported are `from"github"` (default), `..."github-rel"`, `..."gitlab"`, `..."bitbucket"`, `..."notabug"` (short names: `gh`, `gh-r`, `gl`, `bb`, `nb`). Can also be a full domain name (e.g. for GitHub enterprise). **Does not work with snippets.**</div>                                   |
...
|                                      Modifier                                       | Description                                                                                                                                                                                                                                                                                        |
| :---------------------------------------------------------------------------------: | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|  [**`pick`**](http://muttakinhasib.github.io/zinit/wiki/Sourcing-multiple-files/)   | <div align="justify" style="text-align: justify;">Select the file to source, or the file to set as command (when using `snippet --command` or the ice `as"program"`); it is a pattern, alphabetically first matched file is being chosen; e.g. `zinit ice pick"*.plugin.zsh"; zinit load …`.</div> |
|   [**`src`**](http://muttakinhasib.github.io/zinit/wiki/Sourcing-multiple-files)    | <div align="justify" style="text-align: justify;">Specify additional file to source after sourcing main file or after setting up command (via `as"program"`). It is not a pattern but a plain file name.</div>                                                                                     |
| [**`multisrc`**](http://muttakinhasib.github.io/zinit/wiki/Sourcing-multiple-files) | <div align="justify" style="text-align: justify;">Allows to specify multiple files for sourcing, enumerated with spaces as the separators (e.g. `multisrc'misc.zsh grep.zsh'`) and also using brace-expansion syntax (e.g. `multisrc'{misc,grep}.zsh'`). Supports patterns.</div>                  |

### Conditional Loading

|                                    Modifier                                     | Description                                                                                                                                                                                                                                                                                                                                                                                                                      |
| :-----------------------------------------------------------------------------: | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [**`wait`**](http://muttakinhasib.github.io/zinit/wiki/Example-wait-conditions) | <div align="justify" style="text-align: justify;">Postpone loading a plugin or snippet. For `wait'1'`, loading is done `1` second after prompt. For `wait'[[ ... ]]'`, `wait'(( ... ))'`, loading is done when given condition is meet. For `wait'!...'`, prompt is reset after load. Zsh can start 80% (i.e.: 5x) faster thanks to postponed loading. **Fact:** when `wait` is used without value, it works as `wait'0'`.</div> |
|    [**`load`**](http://muttakinhasib.github.io/zinit/wiki/Multiple-prompts)     | <div align="justify" style="text-align: justify;">A condition to check which should cause plugin to load. It will load once, the condition can be still true, but will not trigger second load (unless plugin is unloaded earlier, see `unload` below). E.g.: `load'[[ $PWD = */github* ]]'`.</div>                                                                                                                              |
|   [**`unload`**](http://muttakinhasib.github.io/zinit/wiki/Multiple-prompts)    | <div align="justify" style="text-align: justify;">A condition to check causing plugin to unload. It will unload once, then only if loaded again. E.g.: `unload'[[ $PWD != */github* ]]'`.</div>                                                                                                                                                                                                                                  |
...
| [**`atclone`**](http://muttakinhasib.github.io/zinit/wiki/atload-and-other-at-ices) | <div align="justify" style="text-align: justify;">Run command after cloning, within plugin's directory, e.g. `zinit ice atclone"echo Cloned"`. Ran also after downloading snippet.</div>                                                                                                                                                                             |
| [**`atpull`**](http://muttakinhasib.github.io/zinit/wiki/atload-and-other-at-ices)  | <div align="justify" style="text-align: justify;">Run command after updating (**only if new commits are waiting for download**), within plugin's directory. If starts with "!" then command will be ran before `mv` & `cp` ices and before `git pull` or `svn update`. Otherwise it is ran after them. Can be `atpull'%atclone'`, to repeat `atclone` Ice-mod.</div> |
| [**`atinit`**](http://muttakinhasib.github.io/zinit/wiki/atload-and-other-at-ices)  | <div align="justify" style="text-align: justify;">Run command after directory setup (cloning, checking it, etc.) of plugin/snippet but before loading.</div>                                                                                                                                                                                                         |
| [**`atload`**](http://muttakinhasib.github.io/zinit/wiki/atload-and-other-at-ices)  | <div align="justify" style="text-align: justify;">Run command after loading, within plugin's directory. Can be also used with snippets. Passed code can be preceded with `!`, it will then be investigated (if using `load`, not `light`).</div>                                                                                                                     |
...
|    [**`make`**](http://muttakinhasib.github.io/zinit/wiki/Installing-with-make)     | <div align="justify" style="text-align: justify;">Run `make` command after cloning/updating and executing `mv`, `cp`, `atpull`, `atclone` Ice mods. Can obtain argument, e.g. `make"install PREFIX=/opt"`. If the value starts with `!` then `make` is ran before `atclone`/`atpull`, e.g. `make'!'`.</div>                                                          |
...
|     [**`id-as`**](http://muttakinhasib.github.io/zinit/wiki/id-as/)      | <div align="justify" style="text-align: justify;">Nickname a plugin or snippet, to e.g. create a short handler for long-url snippet.</div>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
[f-sy-h](https://github.com/muttakinhasib/fast-syntax-highlighting))
...
![image](https://raw.githubusercontent.com/muttakinhasib/zinit/images/mod-auto-compile.png)
...
```zsh
sh -c "$(curl -fsSL https://raw.githubusercontent.com/muttakinhasib/zinit/master/doc/mod-install.sh)"
```
...
zinit as"null" wait"1" lucid for \
    ...
    sbin"bin/git-dsf;bin/diff-so-fancy" \
            muttakinhasib/zsh-diff-so-fancy \
    sbin"git-url;git-guclone" make"GITURL_NO_CGITURL=1" \
            muttakinhasib/git-url
```
...
backlog](https://github.com/muttakinhasib/zinit/issues). If you love it, consider supporting its
...
- Or via Gitter [![Join the chat at https://gitter.im/muttakinhasib/zinit][gitter-badge]][gitter-link]

[status-badge]: https://travis-ci.org/muttakinhasib/zinit.svg?branch=master
[status-link]: https://travis-ci.org/muttakinhasib/zinit
[mit-badge]: https://img.shields.io/badge/license-MIT-blue.svg
[mit-link]: ./LICENSE
[ver-badge]: https://img.shields.io/github/tag/muttakinhasib/zinit.svg
[ver-link]: https://github.com/muttakinhasib/zinit/releases
[act-badge]: https://img.shields.io/github/commit-activity/y/muttakinhasib/zinit.svg
[gitter-badge]: https://badges.gitter.im/muttakinhasib/zinit.svg
[gitter-link]: https://gitter.im/muttakinhasib/zinit?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge
